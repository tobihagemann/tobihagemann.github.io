...
<blockquote class="blockquote">
  <p>Dear Tobias Hagemann,</p>
  <p>You have not yet uploaded a binary for your app, Spectrum Run. Our records show that this app was created in iTunes Connect more than 150 days ago.</p>
  <p>If you do not upload a binary for your app by 01 October 2012 (Pacific Time), it will be deleted from iTunes Connect. The app name will then be available for another developer to use.</p>
  <p>…</p>
</blockquote>
