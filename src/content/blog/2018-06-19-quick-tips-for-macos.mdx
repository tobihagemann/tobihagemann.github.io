...
date: 2018-06-19
---
<p class="lead">Here are some quick tips for macOS users. Most of them are shortcuts that I use on a daily basis. I'll throw essential tips in as well so that _everyone_ is up to speed but maybe you can find some hidden gems. 😉</p>

## 1. Spotlight
For the love of God, [use Spotlight][spotlight]! You can activate it with <kbd><kbd>Cmd</kbd> + <kbd>Space</kbd></kbd>. With Spotlight, you can find almost anything on your Mac. But you can also use it to open applications, perform simple calculations, and much more.
...
<div class="text-center mb-3">
  <video controls loop poster="/assets/2018-06-19-spotlight.png" preload="none" style="max-width: 800px;">
    <source type="video/mp4" src="/assets/2018-06-19-spotlight.mp4" />
    Your browser does not support the video tag.
  </video>
</div>

## 2. Screenshots
You probably already know [how to take screenshots][screenshots] but for the sake of completeness, these are the shortcuts:
...
<div class="text-center mb-3">
  <video controls loop poster="/assets/2018-06-19-screenshots.png" preload="none" style="max-width: 800px;">
    <source type="video/mp4" src="/assets/2018-06-19-screenshots.mp4" />
    Your browser does not support the video tag.
  </video>
</div>
...
<div class="text-center mb-3">
  <video controls loop poster="/assets/2018-06-19-text-navigation.png" preload="none" style="max-width: 800px;">
    <source type="video/mp4" src="/assets/2018-06-19-text-navigation.mp4" />
    Your browser does not support the video tag.
  </video>
</div>
...
<div class="text-center mb-3">
  <video controls loop poster="/assets/2018-06-19-do-not-disturb.png" preload="none" style="max-width: 400px;">
    <source type="video/mp4" src="/assets/2018-06-19-do-not-disturb.mp4" />
    Your browser does not support the video tag.
  </video>
</div>
...
<div class="text-center mb-3">
  <video controls loop poster="/assets/2018-06-19-hidden-files.png" preload="none" style="max-width: 800px;">
    <source type="video/mp4" src="/assets/2018-06-19-hidden-files.mp4" />
    Your browser does not support the video tag.
  </video>
</div>
...
<div class="text-center">
  <figure class="figure" style="max-width: 516px;">
    <img class="figure-img img-fluid rounded" src="/assets/2018-06-19-modal-dialogs.png" alt="Modal Dialog Example"/>
  </figure>
</div>
...
<div class="text-center mb-3">
  <video controls loop poster="/assets/2018-06-19-change-directory.png" preload="none" style="max-width: 800px;">
    <source type="video/mp4" src="/assets/2018-06-19-change-directory.mp4" />
    Your browser does not support the video tag.
  </video>
</div>
...
<div class="text-center mb-3">
  <video controls loop poster="/assets/2018-06-19-item-operations.png" preload="none" style="max-width: 800px;">
    <source type="video/mp4" src="/assets/2018-06-19-item-operations.mp4" />
    Your browser does not support the video tag.
  </video>
</div>
...
<div class="text-center">
  <figure class="figure" style="max-width: 552px;">
    <img class="figure-img img-fluid rounded" src="/assets/2018-06-19-turn-off.png" alt="Turn Off Dialog"/>
  </figure>
</div>
...
<div class="text-center">
  <figure class="figure" style="max-width: 712px;">
    <img class="figure-img img-fluid rounded" src="/assets/2018-06-19-spectacle-settings.png" alt="Spectacle Settings"/>
  </figure>
</div>

<hr />

That's all I got for now! :tada: Do you have other tips that you find essential? Please let me know via [@tobihagemann][tw-tobiha].
...
[tw-tobiha]: https://twitter.com/tobihagemann "tobihagemann on Twitter"
