...
<p class="lead">In December 2025, something clicked for me. Over the last month, I've spent a lot of my time developing AI assistants. Is "AI Assistant Engineering" even a thing? I'm pretty sure this will become a normal job title at some point.</p>
...
<Figure src="/assets/2026-01-06-human-process.svg" alt="How a human support agent handles a request" maxWidth="100%" rounded={false}>Human support workflow (simplified)</Figure>
...
<Figure src="/assets/2026-01-06-ai-process.svg" alt="How the AI support assistant handles a request" maxWidth="100%" rounded={false}>AI-assisted support workflow (simplified)</Figure>
...
<Figure src="/assets/2026-01-06-human-ai-process.svg" alt="How a human uses the AI support assistant" maxWidth="100%" rounded={false}>Human-in-the-loop workflow (review &amp; approvals)</Figure>
...
<Figure src="/assets/2026-01-06-claude-code.svg" alt="How Claude Code works" maxWidth="100%" rounded={false}>Claude Code mental model (high-level)</Figure>
