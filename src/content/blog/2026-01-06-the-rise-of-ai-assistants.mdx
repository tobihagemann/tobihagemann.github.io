...
<div class="text-center">
  <figure class="figure" style="max-width: 100%;">
    <img class="figure-img img-fluid" src="/assets/2026-01-06-human-process.svg" alt="How a human support agent handles a request"/>
...
<div class="text-center">
  <figure class="figure" style="max-width: 100%;">
    <img class="figure-img img-fluid" src="/assets/2026-01-06-ai-process.svg" alt="How the AI support assistant handles a request"/>
...
<div class="text-center">
  <figure class="figure" style="max-width: 100%;">
    <img class="figure-img img-fluid" src="/assets/2026-01-06-human-ai-process.svg" alt="How a human uses the AI support assistant"/>
...
<div class="text-center">
  <figure class="figure" style="max-width: 100%;">
    <img class="figure-img img-fluid" src="/assets/2026-01-06-claude-code.svg" alt="How Claude Code works"/>
