...
<Figure src="/assets/2017-01-08-cebit-award.jpg" alt="CeBIT Innovation Award 2016" maxWidth="720">CeBIT Innovation Award 2016 for Cryptomator – Sebastian and I received the special award for "Usable Security and Privacy" worth €20,000</Figure>
...
<Figure src="/assets/2017-01-08-tobi-1994.jpg" alt="Tobi 1994" maxWidth="720">Playing some educational game on my dad's [Macintosh Quadra 650](https://en.wikipedia.org/wiki/Macintosh_Quadra_650) in 1994 (5 years old)</Figure>
...
<Figure src="/assets/2017-01-08-somnio.jpg" alt="Somnio" maxWidth="640">Somnio – my first passion project, developed from 2003 to 2006; it's an MMORPG written in REALbasic with RPG Maker XP placeholder graphics; never finished it</Figure>
...
<Figure src="/assets/2017-01-08-tobi-2004.jpg" alt="Tobi 2004" maxWidth="720">Playing the original Ghost Recon on my [eMac](https://en.wikipedia.org/wiki/EMac) in 2004 (14 years old)</Figure>
...
<Figure src="/assets/2017-01-08-world-of-warcraft.jpg" alt="World of Warcraft" maxWidth="720">One of my highlights in World of Warcraft in 2009, getting realm first on the [Tribute to Insanity](http://www.wowhead.com/achievement=3819/a-tribute-to-insanity-25-player) achievement, which granted the [Grand Crusader](http://www.wowhead.com/title=170/grand-crusader) title; I've also made a <a href="https://www.youtube.com/watch?v=ja7g3P_-Ix8" title="Sturmreiter vs. Anub'arak (Tribute to Insanity)" target="_blank" rel="noopener">video</a></Figure>
...
<Figure src="/assets/2017-01-08-vier-gewinnt-challenge.jpg" alt="Vier Gewinnt Challenge" maxWidth="567">Happily examining my newly won iPod shuffle after taking third place at the _Vier Gewinnt Challenge_ (Connect Four Challenge) in 2010</Figure>
...
<Figure src="/assets/2017-01-08-spectrum-run.jpg" alt="Spectrum Run" maxWidth="720">Spectrum Run – my first iOS game, developed and released in 2012</Figure>
...
<Figure src="/assets/2017-01-08-visualized-cv.png" alt="Visualized CV" maxWidth="885">Visualized CV with particular focus on the academic career – assignment for the course _Scientific Visualization_ in 2014</Figure>
