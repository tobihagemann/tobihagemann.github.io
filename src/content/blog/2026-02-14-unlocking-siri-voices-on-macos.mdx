...
<div class="text-center">
  <figure class="figure" style="max-width: 835px;">
    <img class="figure-img img-fluid rounded" src="/assets/2026-02-14-spoken-content-settings.png" alt="System Settings showing Spoken Content with the System voice selector"/>
...
<div class="text-center">
  <figure class="figure" style="max-width: 862px;">
    <img class="figure-img img-fluid rounded" src="/assets/2026-02-14-voice-selection.png" alt="Voice selection panel showing language list and voice settings"/>
