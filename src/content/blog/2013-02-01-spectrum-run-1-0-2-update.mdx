...
Maybe you've seen [my twitter post][tweet] two weeks ago, I put a lot of effort to make this screen look right and good. In the process I've published [THLabel][thlabel-uilabel-subclass-post], a generic UILabel subclass, which additionally allows shadow blur, stroke text and fill gradient.
...
[thlabel-uilabel-subclass-post]: /2012/12/22/thlabel-uilabel-subclass/ "THLabel – UILabel subclass"
