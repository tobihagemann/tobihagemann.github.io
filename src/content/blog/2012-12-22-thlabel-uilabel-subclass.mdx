...
<div class="text-center">
  <figure class="figure float-md-end" style="max-width: 160px;">
    <img class="figure-img img-fluid rounded" src="/assets/2012-12-22-thlabel-screenshot.png" alt="THLabel screenshot"/>
