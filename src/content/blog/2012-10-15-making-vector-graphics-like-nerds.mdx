...
<div class="text-center">
  <figure class="figure float-md-end" style="max-width: 80px;">
    <img class="figure-img img-fluid rounded" src="/assets/2012-10-15-friends-icon.png" alt="Friends Icon"/>
...
[friends-icon]: /assets/2012-10-15-friends-icon.html "Friends Icon's SVG Path"
