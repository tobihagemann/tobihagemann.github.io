...
## Skymatic
Even though we've been developing Cryptomator for some years now, our company Skymatic is just over a year old. We're actively maintaining Cryptomator for all platforms. Oh, and we have a website now: [skymatic.de][skymatic]

Some highlights:

<dl class="row mb-0">
  <dt class="col-md-12 col-lg-2 text-start text-lg-end mb-1">May 9</dt>
  <dd class="col-md-12 col-lg-10 mb-3">
    <p class="mb-0">Release of Cyberduck 6.0 by iterate with Cryptomator integration. <small class="text-muted">More details [here](https://cryptomator.org/coop/cyberduck_en.html).</small></p>
  </dd>
  <dt class="col-md-12 col-lg-2 text-start text-lg-end mb-1">July 1</dt>
  <dd class="col-md-12 col-lg-10 mb-3">
    <p class="mb-0">Release of Cryptomator 1.3 with major refactorings. <small class="text-muted">More details [here](https://cryptomator.org/blog/2017/07/01/release-1.3.0_en.html).</small></p>
  </dd>
  <dt class="col-md-12 col-lg-2 text-start text-lg-end mb-1">July 21</dt>
  <dd class="col-md-12 col-lg-10 mb-3">
    <p class="mb-0">Soft Launch of Cryptomator Community. <small class="text-muted">More details [here](https://cryptomator.org/blog/2017/09/13/community_en.html).</small></p>
  </dd>
  <dt class="col-md-12 col-lg-2 text-start text-lg-end mb-1">September 7</dt>
  <dd class="col-md-12 col-lg-10 mb-3">
    <p class="mb-0">Release of Mountain Duck 2.0 by iterate with Cryptomator integration. <small class="text-muted">More details [here](https://cryptomator.org/coop/mountainduck_en.html).</small></p>
  </dd>
  <dt class="col-md-12 col-lg-2 text-start text-lg-end mb-1">October 17</dt>
  <dd class="col-md-12 col-lg-10 mb-3">
    <p class="mb-0">Release of Cryptomator 1.0 for Android on Google Play. <small class="text-muted">More details [here](https://cryptomator.org/blog/2017/10/17/android-1.0_en.html).</small></p>
  </dd>
  <dt class="col-md-12 col-lg-2 text-start text-lg-end mb-1">November 8</dt>
  <dd class="col-md-12 col-lg-10 mb-3">
    <p class="mb-0">Winner of DWNRW-Battle in Düsseldorf. <small class="text-muted">More details [here](https://www.digitalhub.de/dwnrw-summit-bonn-war-vorne-mit-dabei/).</small></p>
  </dd>
  <dt class="col-md-12 col-lg-2 text-start text-lg-end mb-1">November 23</dt>
  <dd class="col-md-12 col-lg-10 mb-3">
    <p class="mb-0">Winner of Rheinland-Pitch Semifinals in Bonn. <small class="text-muted">More details [here](https://twitter.com/BonnHub/status/933784327552454656).</small></p>
  </dd>
  <dt class="col-md-12 col-lg-2 text-start text-lg-end mb-1">November 27</dt>
  <dd class="col-md-12 col-lg-10 mb-3">
    <p class="mb-0">Runner-up of Rheinland-Pitch Final in Cologne. <small class="text-muted">More details [here](http://www.startplatz.de/groesster-startup-pitch-wettbewerb-deutschlands-feiert-jubilaeum/).</small></p>
  </dd>
  <dt class="col-md-12 col-lg-2 text-start text-lg-end mb-1">November 27</dt>
  <dd class="col-md-12 col-lg-10 mb-3">
    <p class="mb-0">Release of GMX Tresor and WEB.DE Tresor. <small class="text-muted">More details [here](https://cryptomator.org/coop/gmx_en.html) and [here](https://cryptomator.org/coop/webde_en.html).</small></p>
  </dd>
</dl>
...
<div class="text-center">
  <div class="ratio ratio-16x9 mx-auto mb-2" style="max-width: 720px;">
    <iframe src="https://www.youtube-nocookie.com/embed/ChpLV9AMqm4"></iframe>
  </div>
  <p class="figure-caption">[John Wick: Chapter 2 – Trailer](https://www.youtube.com/watch?v=ChpLV9AMqm4) by Lionsgate Movies</p>
</div>
...
<div class="text-center">
  <div class="ratio ratio-16x9 mx-auto mb-2" style="max-width: 720px;">
    <iframe src="https://www.youtube-nocookie.com/embed/lIY6zFL95hE"></iframe>
  </div>
  <p class="figure-caption">[The Punisher – Trailer](https://www.youtube.com/watch?v=lIY6zFL95hE) by Netflix</p>
</div>
...
<div class="text-center">
  <div class="ratio ratio-16x9 mx-auto mb-2" style="max-width: 720px;">
    <iframe src="https://www.youtube-nocookie.com/embed/xuCn8ux2gbs"></iframe>
  </div>
  <p class="figure-caption">[history of the entire world, i guess](https://www.youtube.com/watch?v=xuCn8ux2gbs) by [bill wurtz](https://www.youtube.com/user/billwurtz)</p>
</div>
...
<div class="text-center">
  <div class="ratio ratio-16x9 mx-auto mb-2" style="max-width: 720px;">
    <iframe src="https://www.youtube-nocookie.com/embed/u6oPBIVjf8E"></iframe>
  </div>
  <p class="figure-caption">[Super Mario Odyssey – Trailer](https://www.youtube.com/watch?v=u6oPBIVjf8E) by Nintendo</p>
</div>
...
<div class="text-center">
  <figure class="figure" style="max-width: 720px;">
    <img class="figure-img img-fluid rounded" src="/assets/2017-12-29-nintendo-switch.jpg" alt="Nintendo Switch"/>
    <figcaption class="figure-caption">Nintendo Switch ❤️</figcaption>
  </figure>
</div>
...
<div class="text-center">
  <figure class="figure" style="max-width: 720px;">
    <img class="figure-img img-fluid rounded" src="/assets/2017-12-29-spotify.png" alt="My 2017 Wrapped on Spotify"/>
