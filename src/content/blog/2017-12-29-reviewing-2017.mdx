...
<DescriptionList>
  <DescriptionEntry term="May 9">Release of Cyberduck 6.0 by iterate with Cryptomator integration. <small class="text-muted">More details [here](https://cryptomator.org/coop/cyberduck_en.html).</small></DescriptionEntry>
  <DescriptionEntry term="July 1">Release of Cryptomator 1.3 with major refactorings. <small class="text-muted">More details [here](https://cryptomator.org/blog/2017/07/01/release-1.3.0_en.html).</small></DescriptionEntry>
  <DescriptionEntry term="July 21">Soft Launch of Cryptomator Community. <small class="text-muted">More details [here](https://cryptomator.org/blog/2017/09/13/community_en.html).</small></DescriptionEntry>
  <DescriptionEntry term="September 7">Release of Mountain Duck 2.0 by iterate with Cryptomator integration. <small class="text-muted">More details [here](https://cryptomator.org/coop/mountainduck_en.html).</small></DescriptionEntry>
  <DescriptionEntry term="October 17">Release of Cryptomator 1.0 for Android on Google Play. <small class="text-muted">More details [here](https://cryptomator.org/blog/2017/10/17/android-1.0_en.html).</small></DescriptionEntry>
  <DescriptionEntry term="November 8">Winner of DWNRW-Battle in Düsseldorf. <small class="text-muted">More details [here](https://www.digitalhub.de/dwnrw-summit-bonn-war-vorne-mit-dabei/).</small></DescriptionEntry>
  <DescriptionEntry term="November 23">Winner of Rheinland-Pitch Semifinals in Bonn. <small class="text-muted">More details [here](https://twitter.com/BonnHub/status/933784327552454656).</small></DescriptionEntry>
  <DescriptionEntry term="November 27">Runner-up of Rheinland-Pitch Final in Cologne. <small class="text-muted">More details [here](http://www.startplatz.de/groesster-startup-pitch-wettbewerb-deutschlands-feiert-jubilaeum/).</small></DescriptionEntry>
  <DescriptionEntry term="November 27">Release of GMX Tresor and WEB.DE Tresor. <small class="text-muted">More details [here](https://cryptomator.org/coop/gmx_en.html) and [here](https://cryptomator.org/coop/webde_en.html).</small></DescriptionEntry>
</DescriptionList>
...
<Embed src="https://www.youtube-nocookie.com/embed/ChpLV9AMqm4" maxWidth="720">[John Wick: Chapter 2 – Trailer](https://www.youtube.com/watch?v=ChpLV9AMqm4) by Lionsgate Movies</Embed>
...
<Embed src="https://www.youtube-nocookie.com/embed/lIY6zFL95hE" maxWidth="720">[The Punisher – Trailer](https://www.youtube.com/watch?v=lIY6zFL95hE) by Netflix</Embed>
...
<Embed src="https://www.youtube-nocookie.com/embed/xuCn8ux2gbs" maxWidth="720">[history of the entire world, i guess](https://www.youtube.com/watch?v=xuCn8ux2gbs) by [bill wurtz](https://www.youtube.com/user/billwurtz)</Embed>
...
<Embed src="https://www.youtube-nocookie.com/embed/u6oPBIVjf8E" maxWidth="720">[Super Mario Odyssey – Trailer](https://www.youtube.com/watch?v=u6oPBIVjf8E) by Nintendo</Embed>
...
<Figure src="/assets/2017-12-29-nintendo-switch.jpg" alt="Nintendo Switch" maxWidth="720">Nintendo Switch ❤️</Figure>
...
<Figure src="/assets/2017-12-29-spotify.png" alt="My 2017 Wrapped on Spotify" maxWidth="720">My 2017 Wrapped on Spotify</Figure>
