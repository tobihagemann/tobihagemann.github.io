...
date: 2025-07-05
---
<p class="lead">I've programmed for 25 years, but in the past weeks, I barely wrote any code myself. I'd like to tell you about my first personal "vibe coding" side project Energiekuchen and how it changed my perspective on building software.</p>

## The Journey Begins

My journey into vibe coding actually began on May 20, when ChatGPT Codex was unlocked for ChatGPT Team users. Three days later, on May 23, I tested it by creating my first vibe coding project: a small internal tool for [Skymatic][skymatic]. But I wasn't impressed. The browser interface was too cumbersome, everything felt sluggish and isolated. Setting up the environment was tedious, especially since it had no internet access once running. I considered trying the Codex CLI but was already quite happy with VS Code and GitHub Copilot, where the agentic features worked smoothly (at first). A couple of weeks later, Codex gained internet access, but it still didn't convince me. I'm curious what OpenAI's answer to all of this will be.

While creating that Skymatic tool, I'd googled spec-driven development and stumbled upon Vivek Haldar's blog post about [spec-driven vibe coding][spec-driven-vibe-coding]. The idea was intriguing: let AI write a detailed spec and implement it. But [Energiekuchen][energiekuchen] (literally "Energy Cake" in German), a web app for visualizing your daily energy levels, was my first personal side project using this approach.
...
Peter Steinberger went wild with agentic engineering (or context engineering, no one really knows what to call it now). His [tweets][steipete-twitter] and [blog posts][steipete-blog] were a blast to read and incredibly inspiring. Before that, I'd read [Harper Reed's blog][harper-blog], which was interesting for getting started but already felt outdated. It's weird how fast everything changes.
...
Just recently, I set up [Claude Code hooks][claude-code-hooks] in Energiekuchen, and I'm curious if I can make use of them. There's so much stuff to learn right now, and all these new tools and features are being released in a matter of weeks or even days.

## The Future is Now

I've open-sourced [Energiekuchen on GitHub][energiekuchen-github] if you want to check out the code.
...
- [Claude Code: Best practices for agentic coding][claude-code-best-practices] by Anthropic
- [AI-assisted coding for teams that can't get away with vibes][ai-assisted-coding] by Atharva Raykar
- [The Future of Vibe Coding: Building with AI, Live and Unfiltered][future-vibe-coding] by Peter Steinberger
- [My AI Skeptic Friends Are All Nuts][youre-all-nuts] by Thomas Ptacek
- [Stop Over-thinking AI Subscriptions][stop-overthinking] by Peter Steinberger
- [AI Changes Everything][changes] by Armin Ronacher
- [How I Use Claude Code][how-i-use-claude] by Simon Spiess
...
<div class="text-center">
  <div class="ratio ratio-16x9 mx-auto mb-2" style="max-width: 720px;">
    <iframe src="https://www.youtube-nocookie.com/embed/LCEmiRjPEtQ"></iframe>
  </div>
  <p class="figure-caption">[Software Is Changing (Again)](https://www.youtube.com/watch?v=LCEmiRjPEtQ) by Andrej Karpathy at Y Combinator</p>
</div>
